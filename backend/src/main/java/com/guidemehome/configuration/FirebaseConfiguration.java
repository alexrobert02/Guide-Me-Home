...
public class FirebaseConfiguration {
	...
	public FirebaseApp firebaseApp() {
		final var serviceAccountJson = fireBaseConfigurationProperties.getFirebase().getServiceAccountFilePath();
		final var serviceAccount = new FileInputStream(serviceAccountJson);
